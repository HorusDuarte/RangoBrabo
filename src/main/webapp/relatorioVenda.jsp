...
<%@page import="com.rangobravo.web.controller.VendaController"%>
<%@page import="java.util.List"%>
<%@page import="com.rangobravo.web.model.Venda"%>
<%@page import="com.rangobravo.web.dao.VendaDAO"%>
...
<html>
    ...
    <body>
        <form action="relatorio-venda" method="post">
            <div style="background:#FD8121" class="jumbotron jumbotron-fluid">
                <div class="container">
